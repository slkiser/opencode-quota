...
| Kimi Code                | Use `KIMI_API_KEY` or `KIMI_CODE_API_KEY`, or trusted user/global OpenCode config / auth.json under `kimi-code-plan-global`. Repo-local provider secrets are ignored.                                                                 |
| Kimi Code (CN)           | Use `KIMI_API_KEY` or `KIMI_CODE_API_KEY`, or trusted user/global OpenCode config / auth.json under `kimi-code-plan-cn`, `kimi-for-coding`, `kimi-code`, or `kimi`. Repo-local provider secrets are ignored.                           |
